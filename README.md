...
## Structure
- Main Program REPL Code located in [`index.ts`](./src/index.ts)
- Grid located in [`index.ts`](./src/Grid/index.ts)
- Library for readline located in [`index.ts`](./src/lib/ask.ts)
- Unit Tests located in [`index.test.ts`](./src/index.test.ts)
